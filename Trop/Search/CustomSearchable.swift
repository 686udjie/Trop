...
private struct CustomSearchBar: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<CustomSearchBar>) -> NavSearchBarWrapper {
    ...
    func updateUIViewController(_ controller: NavSearchBarWrapper, context: UIViewControllerRepresentableContext<CustomSearchBar>) {
